...
function Feedback({ params: paramsPromise }) {
  ...
  const getRatingBadgeColor = (rating) => {
    const numRating = parseFloat(rating)
    if (numRating >= 8) return 'bg-green-100 dark:bg-green-900/30 text-green-800 border-green-300'
    if (numRating >= 6) return 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 border-blue-300'
    if (numRating >= 4) return 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 border-yellow-300 dark:border-yellow-700/50'
  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 max-w-3xl mx-auto w-full">
      ...
      {feedbackList?.length == 0 ? (
        <h2 className="font-bold text-xl text-gray-500 dark:text-gray-400 dark:text-gray-500 text-center sm:text-left">
        ...
        <>
          ...
          <div className="my-6 p-6 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border-2 border-blue-200 dark:border-blue-700/40">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                <h3 className="text-sm text-gray-600 dark:text-gray-300 font-medium">Overall Interview Rating</h3>
              ...
              <div className="text-right">
                <div className="text-sm text-gray-600 dark:text-gray-300">Based on {feedbackList.length} questions</div>
          ...
          <h2 className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 text-center sm:text-left mb-6">
          ...
          {feedbackList && feedbackList.map((item, index) => (
            <Collapsible key={index} className="mt-6">
              ...
              <CollapsibleTrigger
                ...
                text-left w-full text-sm sm:text-base hover:bg-gray-100 dark:bg-gray-800 transition-colors"
              >
              ...
              <CollapsibleContent>
                <div className="flex flex-col gap-3 mt-2">
                  ...
                  <h2 className="p-3 border rounded-lg bg-red-50 dark:bg-red-900/20 text-xs sm:text-sm text-red-900">
                    <strong>Your Answer: </strong>
                    {item.userAns || <span className="text-red-400 italic">No answer recorded</span>}
                  </h2>

                  <h2 className="p-3 border rounded-lg bg-green-50 dark:bg-green-900/20 text-xs sm:text-sm text-green-900">
                    <strong>Correct Answer: </strong>{item.correctAns}
                  </h2>

                  <h2 className="p-3 border rounded-lg bg-blue-50 dark:bg-blue-900/20 text-xs sm:text-sm text-primary">
          ...
          {/* Performance Summary */}
          <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-950 rounded-lg border">
