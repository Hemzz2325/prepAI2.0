...
export default function Assessment() {
    ...
    return (
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            {/* PROGRESS HEADER */}
            <div className="flex justify-between mb-8 text-sm font-semibold text-gray-500 uppercase tracking-wider">
            ...
            {section === SECTIONS.READING && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Reading Assessment</h2>
                    <p className="text-gray-600 mb-6">Read the following paragraph aloud clearly and at a natural pace.</p>

                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 mb-6">
                        <p className="text-lg text-gray-800 leading-relaxed font-medium">{READING_TEXT}</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        {!isListening ? (
                            ...
                            <div className="flex flex-col items-center w-full">
                                ...
                                <p className="text-sm text-gray-500 mb-4 text-center max-w-md italic">"{transcript}"</p>
            ...
            {section === SECTIONS.EXTEMPORE && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Extempore Speech</h2>
                    <p className="text-gray-600 mb-6">Speak on the topic below for 1 minute.</p>

                    <div className="bg-purple-50 p-8 rounded-xl border border-purple-100 mb-6 text-center">
                        <h3 className="text-xl font-bold text-purple-900 mb-2">Topic:</h3>
                        <p className="text-2xl text-purple-700 font-bold">{topic}</p>
                    </div>

                    <div className="flex flex-col items-center gap-4">
                        <div className="text-4xl font-mono font-bold text-gray-700 mb-4 flex items-center">
                            <Timer className="w-8 h-8 mr-2 text-gray-400" />
                            {timeLeft}s
                        </div>
            ...
            {section === SECTIONS.LISTENING && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">Listening Assessment</h2>
                    <p className="text-gray-600 mb-6">Listen to the sentence and repeat it exactly.</p>

                    <div className="flex justify-center mb-8">
                        <Button onClick={playSentence} variant="outline" className="h-24 w-24 rounded-full border-4 border-blue-100 hover:bg-blue-50">
            ...
            {section === SECTIONS.RESULT && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center">
                    ...
                    <p className="text-gray-600 mb-8">Here is your performance breakdown.</p>
